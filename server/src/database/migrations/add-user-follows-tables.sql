-- ============================================================================
-- Migration: Add user_follows + buddy_discovery_consent + buddy_suggestions_cache
-- ----------------------------------------------------------------------------
-- Mirrors src/database/tables/115-user-follows.sql so deployments that boot
-- before running the full table bundle still have the relations referenced by
-- smart-competition.service / follow.service / buddy-suggestion.service.
