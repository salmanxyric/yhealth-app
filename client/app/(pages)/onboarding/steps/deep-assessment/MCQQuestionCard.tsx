  ...
  return (
    <div className="w-full max-w-[960px] mx-auto">
      ...
      <div className="mb-5 sm:mb-7">
        ...
        <div className="h-2.5 bg-[#0b081e] rounded-xl overflow-hidden">
          <motion.div
      ...
      >
        <div className="flex items-start gap-3 sm:gap-4 mb-6 sm:mb-7">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-500/20 flex items-center justify-center shrink-0">
            <CategoryIcon className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-400" />
          </div>
          <h2 className="text-lg sm:text-xl lg:text-2xl leading-snug font-medium tracking-normal text-white max-w-[780px] break-words">
            {question.question}
          </h2>
        </div>
          ...
          {question.options.map((option, index) => {
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'flex items-center gap-3 sm:gap-4 p-4 sm:p-5 rounded-xl border text-left transition-all duration-200 min-h-[104px]',
                  isSelected
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  <span
                    className={cn(
                      'font-medium text-sm sm:text-base leading-snug tracking-normal block',
                  ...
                  {option.insightValue && (
                    <span className="text-xs sm:text-sm text-[rgba(239,237,253,0.65)] mt-1 block">
                      {option.insightValue}
                    </span>
                  )}
                </div>
        ...
        <motion.button
          ...
          className={cn(
            'w-full mt-6 sm:mt-8 flex items-center justify-center gap-2 px-6 py-3 sm:py-3.5 rounded-xl font-medium text-base transition-all duration-300 border border-white/20',
