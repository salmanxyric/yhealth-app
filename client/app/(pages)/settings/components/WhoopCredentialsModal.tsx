      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-xl font-semibold text-white flex items-center gap-2">
              <Key className="w-5 h-5 text-sky-400" /> WHOOP Credentials
            </h3>
            <p className="text-sm text-slate-400 mt-1">Add your WHOOP Client ID and Client Secret</p>
          </div>
          <button
            onClick={() => {
              onClose();
        ...
        >
          ...
          <div className="flex items-center gap-3 pt-4">
            ...
            >
              {isSavingCredentials ? <><Loader2 className="w-4 h-4 animate-spin" /> Saving...</> : <><Save className="w-4 h-4" /> Save Credentials</>}
            </button>
            <button
              type="button"
              onClick={() => {
