...
`;
    ...
    interface ShaderPassProps {
      material?: { vertexShader: string; fragmentShader: string; uniforms: Record<string, { value: unknown }> };
    ...
    class ShaderPass {
      ...
      constructor(props: ShaderPassProps) {
        this.props = props || {};
        this.uniforms = this.props.material?.uniforms as Record<string, { value: unknown }>;
      }
      init() {
    ...
    class ExternalForce extends ShaderPass {
      ...
      init2(simProps: ExternalForceProps) {
        super.init();
    ...
    class Viscous extends ShaderPass {
      ...
      update(opts?: { viscous: number; iterations: number; dt: number }) {
        if (!opts) { super.update(); return; }
        let fbo_out: THREE.WebGLRenderTarget | null | undefined;
    ...
    class Divergence extends ShaderPass {
      ...
      update(opts?: { vel: THREE.WebGLRenderTarget }) {
        if (opts) this.uniforms.velocity.value = opts.vel.texture;
        super.update();
      }
    }
    ...
    interface FBOSet {
      ...
      [key: string]: THREE.WebGLRenderTarget;
    }
