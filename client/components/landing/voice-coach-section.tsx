  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <p
            className="tracking-[0.25em] uppercase text-xs font-medium mb-4"
        ...
        >
          {voiceStats.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className="voice-stat flex items-center gap-3 px-5 py-3 rounded-2xl border border-white/[0.12] bg-gradient-to-b from-white/[0.06] to-white/[0.02] backdrop-blur-md"
        ...
        >
          {scenarios.map((s) => {
            ...
            return (
              <motion.div
                key={s.context}
                className="scenario-card group relative rounded-3xl border border-white/[0.12] bg-gradient-to-b from-white/[0.06] to-white/[0.02] backdrop-blur-md overflow-hidden transition-all duration-500 hover:border-white/15"
                whileHover={{
                  y: -4,
                  boxShadow: `0 0 60px -15px ${s.glowColor}, 0 0 0 1px rgba(255,255,255,0.1), inset 0 1px 0 rgba(255,255,255,0.06)`,
                }}
              >
                {/* Top gradient line */}
                <div
        ...
        >
          {benefits.map((item) => {
            ...
            return (
              <div
                key={item.label}
                className="voice-benefit-card vc-feature group flex items-start gap-4 rounded-2xl border border-white/[0.12] bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-5 hover:border-white/20 transition-all duration-300"
